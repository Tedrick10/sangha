@php
    $theme = session('website_theme', 'system');
...
<div class="relative inline-block" id="website-theme-dropdown">
    <button type="button" id="website-theme-btn" aria-haspopup="true" aria-expanded="false" class="admin-dropdown-trigger flex items-center gap-2">
        @if($theme === 'light')
    ...
    <div id="website-theme-menu" class="admin-dropdown-panel w-44 hidden" role="menu">
        <form action="{{ route('website.set-theme') }}" method="POST">
            @csrf
