...
<div @class([
    ...
    'prose-h2:mt-14 prose-h2:mb-5 prose-h2:pb-0 prose-h2:text-xl sm:prose-h2:text-2xl prose-h2:font-semibold prose-h2:tracking-tight prose-h2:scroll-mt-24 prose-h2:pl-[1.125rem] prose-h2:border-l-[3px] prose-h2:border-amber-500 dark:prose-h2:border-amber-400 prose-h2:text-stone-900 dark:prose-h2:text-slate-50 first:prose-h2:mt-0' => $isLegalTheme,
    'prose-ul:my-6 prose-ul:pl-1 prose-ul:list-disc prose-ul:marker:text-amber-600 dark:prose-ul:marker:text-amber-400' => $isLegalTheme,
