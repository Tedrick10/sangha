...
@section('title', t('monastery_login'))

@section('content')
<div class="w-full max-w-md">
    <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-1">{{ t('monastery_login') }}</h1>
    <p class="text-slate-600 dark:text-slate-400 text-sm mb-6">{{ t('monastery_login_hint') }}</p>
    ...
    <form method="POST" action="{{ route('monastery.login') }}" class="space-y-4">
        @csrf
        <div>
