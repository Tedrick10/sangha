    ...
    <div class="space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div class="admin-form-group mb-0">
                ...
                <input type="text" name="father_name" id="father_name" value="{{ old('father_name') }}" maxlength="255" class="admin-input" placeholder="{{ $adminFatherPlaceholder }}" required>
            ...
            <div class="admin-form-group mb-0">
                ...
                <input type="text" name="nrc_number" id="nrc_number" value="{{ old('nrc_number') }}" maxlength="100" class="admin-input" placeholder="{{ $adminNrcPlaceholder }}" required>
